...
// WinCE compiling on VS2005's STL causes a lot of C4100 warnings in xlocnum -
...
static const tTimeStamp cInvalidTimeStamp =
    0xFFFFFFFF;  // constant to represent an invalid timestamp
