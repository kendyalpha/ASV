...
// It looks like clang supported lots of C++11 in 2.9, but really kicked off
// in 3.0 Keep this before __GNUC__ check because clang can define __GNUC__
...
// C++11 support in Visual Studio more or less kicked off in VS2010 (_MSC_VER >=
// 1600)
#if _MSC_VER >= 1600
#define NAVICO_CXX11 1
#endif
...
// You may define DISABLE_NAVICO_CXX11 to stop these C++11 workarounds from
// being applied.  This is mainly for third parties, where these might create
// issues.
...
#ifdef __cplusplus
// unused return value from a function (used to deliberately suppress some of
// gcc's warnings)
template <class T>
void NAVICO_UNUSED_RETURN(const T&) {}
#endif
...
#elif defined(POSIX) || \
    defined(__linux)  // some Linux distributions do not define POSIX
...
#define NavStd
#pragma warning(disable : 4786)  /// disable truncated to '255' characters in
...
#define NAVICO_BOOL_OPERATOR(test)                                    \
 private:                                                             \
  ...
  typedef const tDummyClass* tDummyClassPtr;                          \
                                                                      \
 public:                                                              \
  operator tDummyClassPtr() const {                                   \
    return (test) ? reinterpret_cast<tDummyClassPtr>(this) : nullptr; \
  }
#else
#define NAVICO_BOOL_OPERATOR(test) \
...
#elif defined(__GNUC__)
// To use this, you must have also set the default visibility to hidden and set
// this define
